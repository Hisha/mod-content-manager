...
int main(int argc, char **argv) {
	...
	SQL("CREATE TABLE creature_template(entry INT UNSIGNED PRIMARY KEY,name "
		...
		"NOT NULL DEFAULT 1,speed_run FLOAT NOT NULL DEFAULT 1,scale FLOAT NOT "
		"NULL DEFAULT 1,rank INT UNSIGNED NOT NULL DEFAULT 0,dmgschool INT "
		...
		"1,type_flags INT UNSIGNED NOT NULL DEFAULT 0,InhabitType INT UNSIGNED "
		"NOT NULL DEFAULT 1,RegenHealth INT UNSIGNED NOT NULL DEFAULT "
	...
	go += ",AIName VARCHAR(255) NOT NULL DEFAULT '',ScriptName VARCHAR(255) "
		  ...
		  "ENGINE=InnoDB";
	SQL(go);
	SQL("CREATE TABLE creature(guid INT UNSIGNED PRIMARY KEY,id1 INT UNSIGNED "
